...
from protocols.protocol_logger import METRICS_FIELDS

logger = logging.getLogger(__name__)


SCENARIO_OUTPUT_FILE = "data/reports/scenario_protocol_outputs.csv"
SUMMARY_CSV = "data/reports/protocol_summary.csv"
SUMMARY_JSON = "data/reports/protocol_summary.json"
ACCURACY_CSV = "data/reports/protocol_accuracy.csv"
...
def run_evaluation(
    metrics_path: str = "data/reports/protocol_metrics.csv",
    plot_dir: str = DEFAULT_PLOT_DIR,
